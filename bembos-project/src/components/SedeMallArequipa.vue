    ...
    <div>
		<div class="max-container">
            ...
            <div class="pagina-title">
               <h1>VISITA NUESTRO LOCAL EN AREQUIPA MALL AVENTURA</h1>
            </div>          
            <div class="pagina-body">
               <div class="content">
                  <div class="body-main">
                     <h2>Conoce nuestro local de Arequipa Mall Aventura y disfruta de todos sus servicios.</h2>
                     ...
                     <div class="informacion">
                        ...
                        <div class="informacion-body">
                           <span>Dirección:</span>
                           <p>C.C. Mall Aventura Plaza, Local Comercial FC-01 - Av. Porongoche, 54, Arequipa, Perú</p>
                        </div>
